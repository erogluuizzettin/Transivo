...
namespace Transivo.UI.MVC.Helpers
{
    public class MailHelper
    {
        public static bool SendMail(string mailAddress, Guid code)
        {
            ...
            mailMassage.Body = string.Format("<a href='http://localhost:50137//Register/Activate?code={0}'> Aktivasyon için tıklayınız</a>", code);
            mailMassage.IsBodyHtml = true;

            SmtpClient smtpClient = new SmtpClient();
            smtpClient.Host = "smtp.gmail.com";
            smtpClient.Port = 587;
            smtpClient.Credentials = new NetworkCredential(from.Address, "sifre");
